...
<main class="main single">
    ...
    <section class="section headline p-20">
        <div class="content">
            <h1 class="headline-2"><?= the_title() ?></h1>
        </div>
    </section>
    <section class="section main-content p-56-0 p-20">
...
" class="button button-brown">Поделиться <svg viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 11L11 1M11 1H2M11 1V11" stroke="white" stroke-width="1.5"
