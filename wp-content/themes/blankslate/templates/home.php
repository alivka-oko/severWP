...
<section class="section section-home p-56-0">
    ...
    <div class="content">
        <div class="headline">
            <div class="left-side">
                <h1 class="headline-1 wow animate__animated animate__fadeIn">Инновационная лесопромышленная компания
                </h1>
            </div>
            <div class="right-side">
                <p class="text-2">Используя передовые технологии и придерживаясь высоких экологических стандартов,
                    компания обеспечивает сохранение окружающей среды через эффективные методы обработки леса.</p>
